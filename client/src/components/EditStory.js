...
function EditStory(props) {
      ...
      const optionGenerator = (member) => {
        //   if(member.id===updateStory.assignedTo){
        //     return (
        //         <option key={member.id} value={member.id} selected>
        //             {member.userName}
        //         </option>
        //     );
        //   }else{
    ...
    //   if(members!==null&&updateStory){
    //       document.getElementById('member').defaultValue = updateStory.assignedTo
    //   }
    ...
    if(updateStory&&projectData){
      return (
        <form
              ...
              console.log(e.target.elements.member.value);
                        ...
                        try {
                            if(parseInt(sprint.value)>parseInt(projectData.totalSprints)){
                                throw Error('Sprint Value cannot be greater than total sprints of project');
                            }
            ...
            <label>
                        Assigned To:
                        <select name="member" id="member" defaultValue={`${updateStory.assignedTo}`}>
                            {members}
                        </select>
                    </label>
            </div>
                    <div className="form-group">
                        <label>
                            Description:
                            <br />
                            <input defaultValue={`${updateStory.description}`}
                                ref={(node) => {
                                    description = node;
                                }}
                            />
                    ...
                    <div className="form-group">
                        <label>
                            Priority
                            <br />
                            <input type='number' defaultValue={`${updateStory.priority}`}
                                ref={(node) => {
                                    priority = node;
                                }}
                            />
                    ...
                    <div className="form-group">
                        <label>
                            ...
                            <br />
                            <input type='number' defaultValue={`${updateStory.sprint}`}
                                ref={(node) => {
                                    sprint = node;
                                }}
                            />
            ...
            <div className="form-group">
                        <label>
                            Story Point:
                            <br />
                            <input type='number' defaultValue={`${updateStory.storyPoint}`}
                                ref={(node) => {
                                    story_point = node;
                                }}
                            />
            ...
            <div className="form-group">
                        <label>
                            Title:
                            <br />
                            <input defaultValue={`${updateStory.title}`}
                                ref={(node) => {
                                    title = node;
                                }}
